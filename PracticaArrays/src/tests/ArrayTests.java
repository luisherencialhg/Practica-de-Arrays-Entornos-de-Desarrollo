...
public class ArrayTests {
    ...
    @Before
    public void setUp() {
        // Inicializa los arrays de prueba utilizando las variables de instancia
        notasValidas = new int[]{7, 8, 9, 5, 6};
        notasNoValidas = new int[]{7, 8, 11, 5, 6}; // Contiene un valor no válido (11)
    }
